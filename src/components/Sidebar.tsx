...
export default function App({
  ...
  return (
    <div className="sticky top-[89px]">
      <ul className="h-full text-foreground box-border bg-content1 outline-none shadow-medium rounded-large transition-transform-background flex w-full flex-col p-3 CodeDemo mb-3 gap-3 text-gray-700">
