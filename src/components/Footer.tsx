...
export default function Footer() {
  return (
    <>
      <footer className=" dark:text-white text-gray-900 border-t-1">
        <div className="mx-auto w-full p-4 py-6 lg:py-8  max_width">
          <div className="md:flex md:justify-between">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                <h2 className="mb-6 text-sm font-semibold  uppercase className">
                  Resources UI
                </h2>
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  ...
                  <li className="mb-4">
                    <a href="https://nextui.org/" className="hover:underline">
                      Nextui
                    </a>
                  </li>
                  <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="flex mt-4 sm:justify-center sm:mt-0">
              ...
              <a
                href="https://twitter.com/jiafengwang_yo"
                className="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5"
              >
                <svg
                  className="w-4 h-4"
